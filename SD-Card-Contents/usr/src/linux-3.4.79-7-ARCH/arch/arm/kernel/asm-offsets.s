	...
	.file	"asm-offsets.c"
@ GNU C (crosstool-NG 1.19.0) version 4.8.3 20131219 (prerelease) (arm-unknown-linux-gnueabihf)
@	compiled by GNU C version 4.8.1, GMP version 5.1.3, MPFR version 3.1.2, MPC version 1.0.1
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -fpreprocessed /tmp/distccd_94acf666.i -mlittle-endian
@ -marm -mabi=aapcs-linux -mno-thumb-interwork -march=armv7-a
@ -mfloat-abi=soft -mfpu=vfpv3-d16 -mtls-dialect=gnu
@ -auxbase-strip /tmp/distccd_94bbf666.o -Os -Wall -Wundef
...
@ 0 "" 2
	...
	.fnend
	.size	main, .-main
	.ident	"GCC: (crosstool-NG 1.19.0) 4.8.3 20131219 (prerelease)"
