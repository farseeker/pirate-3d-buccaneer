...
"armv7l-linux-thread-multi-3.4.75-1-arch" or
	die "Errno architecture (armv7l-linux-thread-multi-3.4.75-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
