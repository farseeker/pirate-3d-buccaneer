...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-shared' '--with-threads' "
                ...
                "'--without-ensurepip' 'CFLAGS=-march=armv7-a "
                '-mfloat-abi=hard -mfpu=vfpv3-d16 -O2 -pipe '
                "-fstack-protector --param=ssp-buffer-size=4' 'LDFLAGS=' "
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Werror=declaration-after-statement '
                   '-DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes '
                   '-march=armv7-a -mfloat-abi=hard -mfpu=vfpv3-d16 -O2 '
                   '-pipe -fstack-protector --param=ssp-buffer-size=4 '
                   '-march=armv7-a -mfloat-abi=hard -mfpu=vfpv3-d16 -O2 '
                   '-pipe -fstack-protector --param=ssp-buffer-size=4 -I. '
                   '-IInclude -I./Include -D_FORTIFY_SOURCE=2 '
