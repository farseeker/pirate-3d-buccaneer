...
private:
	...
	unsigned int layerPrev = 0;
	unsigned int total_3percent = totalLayers*0.03;
	    ...
	    if ((totalLayers < 35) || ((layerNr+1 - layerPrev) >= total_3percent))
	    {
        ...
        layerPrev = 0;
        total_3percent = totalLayers*0.03;
