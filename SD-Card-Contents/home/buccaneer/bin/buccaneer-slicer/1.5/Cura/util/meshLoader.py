...
from util.meshLoaders import stl
from util.meshLoaders import obj
from util.meshLoaders import dae
from util.meshLoaders import amf
...
def loadMeshes(filename, userScale = None):
	ext = os.path.splitext(filename)[1].lower()
	return stl.loadScene(filename,userScale)
	if ext == '.stl':
